...
Suite *s21_suite_is_greater_or_equal(void) {
  ...
  tcase_add_loop_test(tc, is_greater_or_equal_8, 0, 100);
  tcase_add_loop_test(tc, is_greater_or_equal_9, 0, 100);
  tcase_add_loop_test(tc, is_greater_or_equal_10, 0, 100);
