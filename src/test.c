...
printf("\nDEC2 sign:%u scale:%u %u %u %u\n",src2.bits[3]>>31, small_find_out_the_degree(src2),src2.bits[2],src2.bits[1],src2.bits[0]);
...
//   printf("\nORIGINAL %u %u %u %u\n", original_res.bits[3]>>16,original_res.bits[2],original_res.bits[1],original_res.bits[0]);
  printf("\nRESULT %u %u %u %u %u\n",res.bits[3]>>31, small_find_out_the_degree(res),res.bits[2],res.bits[1],res.bits[0]);
