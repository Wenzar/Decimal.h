      ...
      if (add_return != 3) {
        ...
        if ((!big_getBit(current_value_1, 223) &&
          ...
          if (mantis_s21_is_equal(current_value_1, current_value_2)) {
            ...
            big_set_degree(&big_result,
                           find_out_the_degree(current_value_1) -
                               find_out_the_degree(current_value_2));
            ...
            // printf("\nHERE:%u\n raise%d
            // %d",find_out_the_degree(current_value_1),raise_scale(&tmp_decimal),mantis_is_greater(current_value_2,
            // current_value_1));
